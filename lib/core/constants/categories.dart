...
final List<Formula> formulas = [
  ...
  Formula(
    id: 'f8a',
    title: 'Kare Köşegeni',
    description: 'Karenin bir köşegeninin uzunluğu.',
    formulaText: r'd = a\sqrt{2}',
    imagePath: null,
    categoryId: 'square',
    isFavorited: false,
  ),
  Formula(
    id: 'f8b',
    title: 'Kenar Uzunluğu (Alana Göre)',
    description: 'Alan biliniyorsa kenar uzunluğu.',
    formulaText: r'a = \sqrt{A}',
    imagePath: null,
    categoryId: 'square',
    isFavorited: false,
  ),
  Formula(
    id: 'f8c',
    title: 'Kenar Uzunluğu (Çevreye Göre)',
    description: 'Çevre biliniyorsa kenar uzunluğu.',
    formulaText: r'a = \frac{Ç}{4}',
    imagePath: null,
    categoryId: 'square',
    isFavorited: false,
  ),
  Formula(
    id: 'f8d',
    title: 'Kenar Uzunluğu (Köşegene Göre)',
    description: 'Köşegen uzunluğu biliniyorsa kenar uzunluğu.',
    formulaText: r'a = \frac{d}{\sqrt{2}}',
    imagePath: null,
    categoryId: 'square',
    isFavorited: false,
  ),
  Formula(
    id: 'f8e',
    title: 'İçine Çizilen Çemberin Yarıçapı',
    description: 'Karenin içine çizilen çemberin yarıçapı.',
    formulaText: r'r = \frac{a}{2}',
    imagePath: null,
    categoryId: 'square',
    isFavorited: false,
  ),
  Formula(
    id: 'f8f',
    title: 'Çevreleyen Çemberin Yarıçapı',
    description: 'Karenin köşelerinden geçen çemberin yarıçapı.',
    formulaText: r'R = \frac{a\sqrt{2}}{2}',
    imagePath: null,
    categoryId: 'square',
    isFavorited: false,
  ),
  ...
  Formula(
    id: 'f10a',
    title: 'Dikdörtgen Köşegeni',
    description: 'Dikdörtgenin bir köşegeninin uzunluğu.',
    formulaText: r'd = \sqrt{a^2 + b^2}',
    imagePath: null,
    categoryId: 'rectangle',
    isFavorited: false,
  ),
  Formula(
    id: 'f10b',
    title: 'Kenar Uzunluğu (Alana Göre)',
    description: 'Alan ve diğer kenar biliniyorsa bir kenar uzunluğu.',
    formulaText: r'a = \frac{A}{b}',
    imagePath: null,
    categoryId: 'rectangle',
    isFavorited: false,
  ),
  Formula(
    id: 'f10c',
    title: 'Kenar Uzunluğu (Çevreye ve Diğer Kenara Göre)',
    description: 'Çevre ve diğer kenar biliniyorsa bir kenar uzunluğu.',
    formulaText: r'a = \frac{Ç}{2} - b',
    imagePath: null,
    categoryId: 'rectangle',
    isFavorited: false,
  ),
  Formula(
    id: 'f10d',
    title: 'Kenar Uzunluğu (Köşegene ve Diğer Kenara Göre)',
    description: 'Köşegen ve diğer kenar biliniyorsa bir kenar uzunluğu.',
    formulaText: r'a = \sqrt{d^2 - b^2}',
    imagePath: null,
    categoryId: 'rectangle',
    isFavorited: false,
  ),
  Formula(
    id: 'f10e',
    title: 'Çevreleyen Çemberin Yarıçapı',
    description: 'Dikdörtgenin köşelerinden geçen çemberin yarıçapı.',
    formulaText: r'R = \frac{\sqrt{a^2 + b^2}}{2}',
    imagePath: null,
    categoryId: 'rectangle',
    isFavorited: false,
  ),
  ...
  Formula(
    id: 'f50a',
    title: 'Birinci Köşegen Uzunluğu',
    description: 'Paralelkenarın birinci köşegeninin uzunluğu.',
    formulaText: r'd_1 = \sqrt{a^2 + b^2 + 2ab\cos\theta}',
    imagePath: null,
    categoryId: 'parallelogram',
    isFavorited: false,
  ),
  Formula(
    id: 'f50b',
    title: 'İkinci Köşegen Uzunluğu',
    description: 'Paralelkenarın ikinci köşegeninin uzunluğu.',
    formulaText: r'd_2 = \sqrt{a^2 + b^2 - 2ab\cos\theta}',
    imagePath: null,
    categoryId: 'parallelogram',
    isFavorited: false,
  ),
  Formula(
    id: 'f50c',
    title: 'Yükseklik (Alana ve Kenara Göre)',
    description: 'Alan ve taban kenarı biliniyorsa yükseklik.',
    formulaText: r'h = \frac{A}{a}',
    imagePath: null,
    categoryId: 'parallelogram',
    isFavorited: false,
  ),
  Formula(
    id: 'f50d',
    title: 'Kenar Uzunluğu (Alana ve Yüksekliğe Göre)',
    description: 'Alan ve yükseklik biliniyorsa kenar uzunluğu.',
    formulaText: r'a = \frac{A}{h}',
    imagePath: null,
    categoryId: 'parallelogram',
    isFavorited: false,
  ),
  ...
  Formula(
    id: 'f50f',
    title: 'İç Açı (Köşegen ve Kenarlara Göre)',
    description: 'Köşegen ve kenarlar biliniyorsa iç açı.',
    formulaText: r'\alpha = \arccos\left(\frac{a^2 + b^2 - d_1^2}{2ab}\right)',
    imagePath: null,
    categoryId: 'parallelogram',
    isFavorited: false,
  ),
  ...
  Formula(
    id: 'f51a',
    title: 'Yükseklik (Alana ve Tabanlara Göre)',
    description: 'Alan ve tabanlar biliniyorsa yükseklik.',
    formulaText: r'h = \frac{2A}{a + b}',
    imagePath: null,
    categoryId: 'trapezoid',
    isFavorited: false,
  ),
  Formula(
    id: 'f51b',
    title: 'Taban Uzunluğu (Alana, Yüksekliğe ve Diğer Tabana Göre)',
    description:
        'Alan, yükseklik ve diğer taban biliniyorsa bir taban uzunluğu.',
    formulaText: r'a = \frac{2A}{h} - b',
    imagePath: null,
    categoryId: 'trapezoid',
    isFavorited: false,
  ),
  Formula(
    id: 'f51c',
    title: 'Orta Taban (Orta Doğru) Uzunluğu',
    description: 'Yamukta tabanların ortalaması.',
    formulaText: r'm = \frac{a + b}{2}',
    imagePath: null,
    categoryId: 'trapezoid',
    isFavorited: false,
  ),
  ...
  Formula(
    id: 'f52a',
    title: 'Alan (Kenar ve Yükseklik ile)',
    description: 'Kenar ve yükseklik ile alan.',
    formulaText: r'A = a \cdot h',
    imagePath: null,
    categoryId: 'rhombus',
    isFavorited: false,
  ...
  Formula(
    id: 'f52b',
    title: 'Yükseklik (Alana ve Kenara Göre)',
    description: 'Alan ve kenar biliniyorsa yükseklik.',
    formulaText: r'h = \frac{A}{a}',
    imagePath: null,
    categoryId: 'rhombus',
    isFavorited: false,
  ...
  Formula(
    id: 'f52d',
    title: 'Kenar Uzunluğu (Köşegenlere Göre)',
    description: 'Köşegenler biliniyorsa kenar uzunluğu.',
    formulaText: r'a = \frac{1}{2} \sqrt{e^2 + f^2}',
    imagePath: null,
    categoryId: 'rhombus',
    isFavorited: false,
  ),
  Formula(
    id: 'f52e',
    title: 'Köşegen Uzunluğu (Alan ve Diğer Köşegene Göre)',
    description: 'Alan ve diğer köşegen biliniyorsa köşegen uzunluğu.',
    formulaText: r'e = \frac{2A}{f}',
    imagePath: null,
    categoryId: 'rhombus',
    isFavorited: false,
  ),
  Formula(
    id: 'f52f',
    title: 'Köşegen Uzunluğu (Kenar ve Diğer Köşegene Göre)',
    description: 'Kenar ve diğer köşegen biliniyorsa köşegen uzunluğu.',
    formulaText: r'e = \sqrt{4a^2 - f^2}',
    imagePath: null,
    categoryId: 'rhombus',
    isFavorited: false,
  ),
  Formula(
    id: 'f52g',
    title: 'İç Açı (Kenar ve Köşegenlere Göre)',
    description: 'Kenar ve köşegenler biliniyorsa iç açı.',
    formulaText: r'\alpha = \arccos\left(\frac{e^2 + f^2 - 4a^2}{2ef}\right)',
    imagePath: null,
    categoryId: 'rhombus',
    isFavorited: false,
  ),
  ...
  Formula(
    ...
    title: 'Kenar Uzunluğu (Alana Göre)',
    description: 'Alan biliniyorsa kenar uzunluğu.',
    formulaText: r'a = \sqrt{\frac{4A}{n \cot(\pi/n)}}',
    imagePath: null,
    categoryId: 'ngon',
    isFavorited: false,
  ),
  ...
  Formula(
    id: 'f55c',
    title: 'İç Açı',
    description: 'Düzenli n-kenarlı çokgende her bir iç açı.',
    formulaText: r'\alpha = \frac{(n-2) \cdot 180^\circ}{n}',
    imagePath: null,
    categoryId: 'ngon',
    isFavorited: false,
  ),
  Formula(
    id: 'f55d',
    title: 'Dış Açı',
    description: 'Düzenli n-kenarlı çokgende her bir dış açı.',
    formulaText: r'\beta = \frac{360^\circ}{n}',
    imagePath: null,
    categoryId: 'ngon',
    isFavorited: false,
  ),
  Formula(
    id: 'f55e',
    title: 'Apotem (Yükseklik)',
    description:
        'n-kenarlı çokgenin merkezinden bir kenara inen dikmenin uzunluğu.',
    formulaText: r'ap = \frac{a}{2} \cot\left(\frac{\pi}{n}\right)',
    imagePath: null,
    categoryId: 'ngon',
    isFavorited: false,
  ),
  Formula(
    id: 'f55f',
    title: 'Çevrel Çemberin Yarıçapı',
    description: 'n-kenarlı çokgenin köşelerinden geçen çemberin yarıçapı.',
    formulaText: r'R = \frac{a}{2 \sin(\pi/n)}',
    imagePath: null,
    categoryId: 'ngon',
    isFavorited: false,
  ),
  Formula(
    id: 'f55g',
    title: 'İç Çemberin Yarıçapı',
    description:
        'n-kenarlı çokgenin içine çizilen çemberin yarıçapı (apotem ile aynı).',
    formulaText: r'r = \frac{a}{2} \cot(\pi/n)',
    imagePath: null,
    categoryId: 'ngon',
    isFavorited: false,
  ),
  ...
  Formula(
    id: 'f22a',
    title: 'Küpün Köşegeni',
    description: 'Küpün bir köşegeninin uzunluğu.',
    formulaText: r'd = a\sqrt{3}',
    imagePath: null,
    categoryId: 'cube',
    isFavorited: false,
  ),
  Formula(
    id: 'f22b',
    title: 'Küpün Kenar Uzunluğu (Hacimden)',
    description: 'Küpün hacminden kenar uzunluğunu bulma.',
    formulaText: r'a = \sqrt[3]{V}',
    imagePath: null,
    categoryId: 'cube',
    isFavorited: false,
  ),
  Formula(
    id: 'f22c',
    title: 'Küpün Kenar Uzunluğu (Yüzey Alanından)',
    description: 'Küpün yüzey alanından kenar uzunluğunu bulma.',
    formulaText: r'a = \sqrt{A/6}',
    imagePath: null,
    categoryId: 'cube',
    isFavorited: false,
  ),
  Formula(
    id: 'f22d',
    title: 'Küpün Bir Yüzeyinin Alanı',
    description: 'Küpün bir yüzeyinin alanı.',
    formulaText: r'A_{yüzey} = a^2',
    imagePath: null,
    categoryId: 'cube',
    isFavorited: false,
  ),
  ...
  Formula(
    id: 'f25a',
    title: 'Silindirin Taban Alanı',
    description: 'Silindirin bir tabanının alanı.',
    formulaText: r'A_{taban} = \pi r^2',
    imagePath: null,
    categoryId: 'cylinder',
    isFavorited: false,
  ),
  Formula(
    id: 'f25b',
    title: 'Silindirin Yan Yüzey Alanı',
    description: 'Silindirin yan yüzeyinin alanı.',
    formulaText: r'A_{yan} = 2\pi r h',
    imagePath: null,
    categoryId: 'cylinder',
    isFavorited: false,
  ),
  Formula(
    id: 'f25c',
    title: 'Silindirin Çapı',
    description: 'Silindirin tabanının çapı.',
    formulaText: r'd = 2r',
    imagePath: null,
    categoryId: 'cylinder',
    isFavorited: false,
  ...
  Formula(
    id: 'f25d',
    title: 'Silindirin Yüksekliği (Hacimden)',
    description: 'Hacim ve yarıçap biliniyorsa yükseklik.',
    formulaText: r'h = \frac{V}{\pi r^2}',
    imagePath: null,
    categoryId: 'cylinder',
    isFavorited: false,
  ),
  Formula(
    id: 'f25e',
    title: 'Silindirin Yarıçapı (Hacimden)',
    description: 'Hacim ve yükseklik biliniyorsa yarıçap.',
    formulaText: r'r = \sqrt{\frac{V}{\pi h}}',
    imagePath: null,
    categoryId: 'cylinder',
    isFavorited: false,
  ),
  Formula(
    id: 'f25f',
    title: 'Silindirin Yarıçapı (Taban Alanından)',
    description: 'Taban alanı biliniyorsa yarıçap.',
    formulaText: r'r = \sqrt{\frac{A_{taban}}{\pi}}',
    imagePath: null,
    categoryId: 'cylinder',
    isFavorited: false,
  ),
  ...
  Formula(
    id: 'f28b',
    title: 'Küre Yarıçapı (Hacimden)',
    description: 'Hacim biliniyorsa yarıçap.',
    formulaText: r'r = \sqrt[3]{\frac{3V}{4\pi}}',
    imagePath: null,
    categoryId: 'sphere',
    isFavorited: false,
  ),
  Formula(
    id: 'f28c',
    title: 'Küre Yarıçapı (Yüzey Alanından)',
    description: 'Yüzey alanı biliniyorsa yarıçap.',
    formulaText: r'r = \sqrt{\frac{A}{4\pi}}',
    imagePath: null,
    categoryId: 'sphere',
    isFavorited: false,
  ),
  Formula(
    id: 'f28d',
    title: 'Küre Dilimi Hacmi',
    description: 'Yüksekliği h olan küre diliminin hacmi.',
    formulaText: r'V_{dilim} = \frac{2}{3} \pi r^2 h',
    imagePath: null,
    categoryId: 'sphere',
    isFavorited: false,
  ),
  Formula(
    id: 'f28e',
    title: 'Küre Kesiti Alanı',
    description:
        'Kürenin herhangi bir düzlemle yapılan dairesel kesitinin alanı.',
    formulaText: r'A_{kesit} = \pi r^2',
    imagePath: null,
    categoryId: 'sphere',
    isFavorited: false,
  ),
  ...
  Formula(
    id: 'f61a',
    title: 'Dikdörtgenler Prizmasında Köşegen',
    description: 'Bir köşeden karşı köşeye çizilen köşegenin uzunluğu.',
    formulaText: r'd = \sqrt{a^2 + b^2 + h^2}',
    imagePath: null,
    categoryId: 'rectangular_prism',
    isFavorited: false,
  ),
  Formula(
    id: 'f61b',
    title: 'Bir Kenar Uzunluğu (Hacimden)',
    description:
        'Hacim ve diğer iki kenar biliniyorsa bir kenar uzunluğunu bulma.',
    formulaText: r'a = \frac{V}{b \cdot h}',
    imagePath: null,
    categoryId: 'rectangular_prism',
    isFavorited: false,
  ),
  Formula(
    id: 'f61c',
    title: 'Bir Kenar Uzunluğu (Yüzey Alanından ve Diğer Kenarlardan)',
    description:
        'Yüzey alanı ve diğer kenarlar biliniyorsa bir kenar uzunluğunu bulma.',
    formulaText: r'a = \frac{A/2 - bc - bh}{c + b}',
    imagePath: null,
    categoryId: 'rectangular_prism',
    isFavorited: false,
  ),
  Formula(
    id: 'f61d',
    title: 'Taban Alanı',
    description: 'Prizmanın tabanının alanı.',
    formulaText: r'A_{taban} = a b',
    imagePath: null,
    categoryId: 'rectangular_prism',
    isFavorited: false,
  ),
  Formula(
    id: 'f61e',
    title: 'Yan Yüzey Alanı',
    description: 'Prizmanın yan yüzeylerinin toplam alanı.',
    formulaText: r'A_{yan} = 2h(a + b)',
    imagePath: null,
    categoryId: 'rectangular_prism',
    isFavorited: false,
  ),
  ...
  Formula(
    id: 'f62a',
    title: 'Koninin Taban Alanı',
    description: 'Koninin tabanının alanı.',
    formulaText: r'A_{taban} = \pi r^2',
    imagePath: null,
    categoryId: 'cone',
    isFavorited: false,
  ...
  Formula(
    id: 'f62b',
    title: 'Koninin Yan Yüzey Alanı',
    description: 'Koninin yan yüzeyinin alanı.',
    formulaText: r'A_{yan} = \pi r l',
    imagePath: null,
    categoryId: 'cone',
    isFavorited: false,
  ),
  Formula(
    id: 'f62c',
    title: 'Koninin Çapı',
    description: 'Koninin tabanının çapı.',
    formulaText: r'd = 2r',
    imagePath: null,
    categoryId: 'cone',
    isFavorited: false,
  ...
  Formula(
    id: 'f62d',
    title: 'Koninin Yüksekliği (Hacimden)',
    description: 'Hacim ve yarıçap biliniyorsa yükseklik.',
    formulaText: r'h = \frac{3V}{\pi r^2}',
    imagePath: null,
    categoryId: 'cone',
    isFavorited: false,
  ),
  Formula(
    id: 'f62e',
    title: 'Koninin Yarıçapı (Hacimden)',
    description: 'Hacim ve yükseklik biliniyorsa yarıçap.',
    formulaText: r'r = \sqrt{\frac{3V}{\pi h}}',
    imagePath: null,
    categoryId: 'cone',
    isFavorited: false,
  ),
  Formula(
    id: 'f62f',
    title: 'Koninin Yarıçapı (Taban Alanından)',
    description: 'Taban alanı biliniyorsa yarıçap.',
    formulaText: r'r = \sqrt{\frac{A_{taban}}{\pi}}',
    imagePath: null,
    categoryId: 'cone',
  ...
  Formula(
    id: 'f62g',
    title: 'Koninin Eğik Kenarı (Ana Doğru)',
    description: 'Koni yüksekliği ve yarıçapı biliniyorsa ana doğru uzunluğu.',
    formulaText: r'l = \sqrt{r^2 + h^2}',
    imagePath: null,
    categoryId: 'cone',
    isFavorited: false,
  ),
