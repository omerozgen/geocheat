...
class IkizkenarUcgenAlanPainter extends StatelessWidget {
  final double size;
  const IkizkenarUcgenAlanPainter({super.key, this.size = 180});

  @override
  Widget build(BuildContext context) {
    return CustomPaint(
      size: Size(size, size),
      painter: _IkizkenarUcgenAlanPainter(),
    );
  }
}

class _IkizkenarUcgenAlanPainter extends CustomPainter {
  @override
