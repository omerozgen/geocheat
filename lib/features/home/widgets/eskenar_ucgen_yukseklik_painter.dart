...
class EskenarUcgenYukseklikPainter extends StatelessWidget {
  final double size;
  const EskenarUcgenYukseklikPainter({super.key, this.size = 180});

  @override
  Widget build(BuildContext context) {
    return CustomPaint(
      size: Size(size, size),
      painter: _EskenarUcgenYukseklikPainter(),
    );
  }
}

class _EskenarUcgenYukseklikPainter extends CustomPainter {
  @override
