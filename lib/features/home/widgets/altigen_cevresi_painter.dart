...
class AltigenCevresiPainter extends StatelessWidget {
  final double size;
  const AltigenCevresiPainter({super.key, this.size = 180});

  @override
  Widget build(BuildContext context) {
    return CustomPaint(
      size: Size(size, size),
      painter: _AltigenCevresiPainter(),
    );
  }
}

class _AltigenCevresiPainter extends CustomPainter {
  @override
