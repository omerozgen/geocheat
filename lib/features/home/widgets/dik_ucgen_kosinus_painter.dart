...
class DikUcgenKosinusPainter extends StatelessWidget {
  final double size;
  const DikUcgenKosinusPainter({super.key, this.size = 180});

  @override
  Widget build(BuildContext context) {
    return CustomPaint(
      size: Size(size, size),
      painter: _DikUcgenKosinusPainter(),
    );
  }
}

class _DikUcgenKosinusPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    ...
    // Kosinüs için komşu dik kenar (b) ve hipotenüs (c) renkli
    final bPaint = Paint()
      ..color = Colors.red
      ..strokeWidth = 4;
