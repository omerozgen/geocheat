...
class DikdortgenlerPrizmasiYanAlanPainter extends StatelessWidget {
  final double size;
  const DikdortgenlerPrizmasiYanAlanPainter({super.key, this.size = 180});

  @override
  Widget build(BuildContext context) {
    return CustomPaint(
      size: Size(size, size),
      painter: _DikdortgenlerPrizmasiYanAlanPainter(),
    );
  }
}

class _DikdortgenlerPrizmasiYanAlanPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    ...
    // Yan yüzeyi vurgulu çiz (ön sağ yüz)
