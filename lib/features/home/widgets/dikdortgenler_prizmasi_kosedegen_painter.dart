...
class DikdortgenlerPrizmasiKosedegenPainter extends StatelessWidget {
  final double size;
  const DikdortgenlerPrizmasiKosedegenPainter({super.key, this.size = 180});

  @override
  Widget build(BuildContext context) {
    return CustomPaint(
      size: Size(size, size),
      painter: _DikdortgenlerPrizmasiKosedegenPainter(),
    );
  }
}

class _DikdortgenlerPrizmasiKosedegenPainter extends CustomPainter {
  @override
