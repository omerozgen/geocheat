...
class AltigenApotemPainter extends StatelessWidget {
  final double size;
  const AltigenApotemPainter({super.key, this.size = 180});

  @override
  Widget build(BuildContext context) {
    return CustomPaint(
      size: Size(size, size),
      painter: _AltigenApotemPainter(),
    );
  }
}

class _AltigenApotemPainter extends CustomPainter {
  @override
