...
class AltigenDisCemberPainter extends StatelessWidget {
  final double size;
  const AltigenDisCemberPainter({super.key, this.size = 180});

  @override
  Widget build(BuildContext context) {
    return CustomPaint(
      size: Size(size, size),
      painter: _AltigenDisCemberPainter(),
    );
  }
}

class _AltigenDisCemberPainter extends CustomPainter {
  @override
