...
class BesgenDisCemberPainter extends StatelessWidget {
  final double size;
  const BesgenDisCemberPainter({super.key, this.size = 180});

  @override
  Widget build(BuildContext context) {
    return CustomPaint(
      size: Size(size, size),
      painter: _BesgenDisCemberPainter(),
    );
  }
}

class _BesgenDisCemberPainter extends CustomPainter {
  @override
